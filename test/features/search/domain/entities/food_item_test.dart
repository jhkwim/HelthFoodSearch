...
void main() {
  const tFoodItem = FoodItem(
    ...
    bsshNm: '(주) 씨스팡',
    prmsDt: '20240101',
    primaryFnclty: '관절건강에 도움을 줄 수 있음',
    pogDaycnt: '제조일로부터 3년',
    dispos: '캡슐',
    ntkMthd: '1일 2회, 1회 2캡슐',
    iftknAtntMatrCn: '특이체질, 알레르기 체질의 경우에는 간혹 개인에 따라 과민반응을 나타낼 수 있으므로 원료를 확인한 후 섭취하십시오.',
    stdrStnd: '1. 성상 : 이미, 이취가 없고 고유의 향미가 있는 담황색의 내용물을 함유한 젤라틴 캡슐',
  );
