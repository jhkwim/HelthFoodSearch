...
void main() {
  ...
  testWidgets('Ingredient selection adds chip to header in MainScreen', (
    WidgetTester tester,
  ) async {
    // Arrange
    ...
    await tester.tap(
      find.text('원료별 검색'),
    ); // Assuming localization 'Ingredient Search' -> '원료별 검색' or similar.
    ...
    final textField = find
        .byType(TextField)
        .at(0); // Should be the one in header
